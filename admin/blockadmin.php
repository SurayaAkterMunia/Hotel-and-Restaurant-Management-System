...
if(isset($_GET['del'])){
    ...
    $query = mysqli_query($con,$sql);
     if($query){
        echo "<script type='text/javascript'> alert('Your admin is removed')</script>";
        echo '<script>window.location="blockadmin.php"</script>';
    }
    else{
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a   class="active-menu"  href="blockadmin.php"><i class="fa fa-pencil-square-o"></i> Update or Delete Admin</a>
                    </li>
                    <li>
