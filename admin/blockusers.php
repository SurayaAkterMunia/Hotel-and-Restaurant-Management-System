...
if(isset($_GET['del'])){
    ...
    if($query){
        ...
        echo '<script>window.location="blockusers.php"</script>';
    }
    else{
    ...
    <div id="wrapper">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                   ...
                   <li>
                    ...
                    <li>
                        <a  class="active-menu" href="blockusers.php"><i class="fa fa-desktop"></i>Update or Delete Staff Login</a>
                    </li>
                      <li>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                ...
                $sql = "select * from users order by id";//ORDER BY id desc
                              ...
                              while($row = mysqli_fetch_assoc($result) )
                                {
                                  ...
                                  echo "<td>";
                                        ...
                                        echo "<td>";
                                            ?>
                                            <a href="blockusers.php?del=<?php echo $row["id"];?>" style="text-align: right; font-family: cursive" class="btn text-danger">Delete</a>
                                            <?php
                                        echo "</td>";
                                    echo "</tr>";
                                }
